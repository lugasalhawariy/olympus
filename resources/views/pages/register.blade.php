      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Buat akun mu sekarang dan kelola uang desa bersama Cybertest.</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form" action="{{ route('register') }}" method="POST">
                ...
                <div class="form1">
                    {{-- data first_name --}}
                    <div class="mb-3">
                        <input name="first_name" type="text" class="form-control" placeholder="Nama Depan" aria-label="Nama Depan">
                    </div>
                    {{-- data last_name --}}
                    <div class="mb-3">
                        <input name="last_name" type="text" class="form-control" placeholder="Nama Belakang" aria-label="Nama Belakang">
                    </div>
                    {{-- data email --}}
                    <div class="mb-3">
                    ...
                    {{-- data pin --}}
                    <div class="mb-3">
                        <input name="pin" type="text" class="form-control" placeholder="Pin" aria-label="Pin">
                    </div>
                    {{-- data phone --}}
                    <div class="mb-3">
                ...
                <div class="text-center">
                  <button id="next_register" type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2">Register</button>
                </div>
